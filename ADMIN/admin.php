...
$sql = "SELECT forname, surname, email, message_content, date_msg FROM contact_messages";
...
<body>
    ...
    <div class="blur-cover">
        ...
        <div class="index-hero-banner">
            ...
            <h2 class="index--lets-go-msg">Vos messages</h2>
            <h1 class="index--title-game-name">ADMIN</h1>
        </div>
        <div class="admin-container-all-message">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<p class="admin-card-msg--label">MESSAGE</p>';
                    echo '<p class="admin-card-msg--date-msg">' . $row['date_msg'] . ' </p>';
                    echo '</div>';
                    echo '<p class="admin-card-msg--content-msg">' . $row['message_content'] . '</p>';
                    echo '<div class="admin-card-msg--footer">';
                    echo '<p class="admin-card-msg--forname-surname-email">' . $row['forname'] . ' ' . $row['surname'] . '<br>';
                    echo '<span class="admin-card-msg--email">oscarprivitera8@gmail.com</span>';
                    echo '</p>';
